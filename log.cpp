#define _CRT_SECURE_NO_WARNINGS //для того чтобы программа запускалась, не смотря на предупреждения (В данном случае программа предлагает использовать localtime_s вместо localtime
#include <iostream>
#include <string> 
#include <cstring>
#include <cstdlib>
#include <ctime>
#include <fstream>
#pragma warning(disable: 4018) //для того чтобы не вызывало ошибку, о разности типов в сравнении i < strlen(sentence) и i < shift.length
